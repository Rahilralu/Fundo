...
import { Search, ChevronDown, CheckCircle2, Calendar, MapPin, Bell, Moon } from 'lucide-react';
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center gap-1.5 mb-6">
                    <span className="text-white/60 text-xs">by {event.user?.name || 'Organizer'}</span>
