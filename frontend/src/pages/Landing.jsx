    ...
    <div className="bg-[#050508] text-white overflow-x-hidden">
      ...
      <section className="relative w-full h-screen flex overflow-hidden">
        ...
        <div className="relative z-20 w-full lg:w-1/2 flex flex-col justify-center px-12 lg:px-20 shrink-0">
          <div className="inline-flex items-center gap-2.5 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-8 w-fit shadow-md shadow-purple-500/5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#c084fc] animate-pulse shadow-[0_0_8px_#c084fc]" />
            <span className="text-[10px] text-purple-200 font-semibold tracking-widest uppercase">Events, Simplified</span>
          </div>
          ...
          <p className="text-[16px] text-white/50 leading-relaxed mb-10 max-w-[420px] font-light">
            Create events, share payment links, and track every rupee — all from one place.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link to="/events"
              ...
              Create Your Event <ArrowRight size={15} className="group-hover:translate-x-0.5 transition-transform" />
            </Link>
      ...
      <section className="py-28 px-6 lg:px-12 max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { icon: <Calendar size={22} />, title: 'Easy Event Creation', desc: 'Set up any event in minutes. Fully customizable.', accent: '#7c5cfc', bg: 'rgba(124,92,252,0.08)' },
      ...
      <section className="py-16 px-6 lg:px-12 pb-24">
        <div className="max-w-[1100px] mx-auto relative overflow-hidden rounded-3xl border border-[#7c5cfc]/20 p-12 md:p-16 text-center"
          ...
          <div className="relative z-10">
            <h2 className="text-[34px] md:text-[44px] font-bold tracking-tight mb-4">Ready to create something amazing?</h2>
            <p className="text-[16px] text-white/40 mb-10 max-w-md mx-auto leading-relaxed">Join thousands of organizers who trust Fundo to run their events.</p>
