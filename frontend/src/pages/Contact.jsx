...
const helpTopics = [
  {
    ...
    desc: 'Learn the basics of Fundo and how to create your first event.',
    articles: [
      {
      ...
      {
        q: "Creating your first event registration",
        a: "Browse the events list, select any public event, and click the Register/Book button. Complete the simulated secure payment through our Razorpay checkout to confirm your seat."
      },
      {
  ...
  },
  {
    ...
    desc: 'Create, manage and share events with your audience.',
    articles: [
      {
...
const initialFaqs = [
  {
    ...
    a: "Currently, Fundo supports event discovery and registration. Organizers can create public and private invite-only events through the administrative dashboard. If you need organizer privileges, contact the Fundo administrator at fundoooooo12@gmail.com."
  },
  {
